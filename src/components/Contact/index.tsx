          ...
          <div className="flex flex-col xl:flex-row gap-7.5">
            ...
            <div className="xl:max-w-[770px] w-full bg-white rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
              <form>
                  ...
                  <div className="form-group w-full">
                    <div className="input-wrapper-enhanced">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="firstName" className="form-label-enhanced">
                  ...
                  <div className="form-group w-full">
                    <div className="input-wrapper-enhanced">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="lastName" className="form-label-enhanced">
                ...
                <div className="form-group mb-7.5">
                  <div className="input-wrapper-enhanced">
                    <textarea
                      name="message"
                      id="message"
                  ...
                  <div className="helper-enhanced">
                    Let us know how we can help you with your Screen Time Journey
                  </div>
                </div>
